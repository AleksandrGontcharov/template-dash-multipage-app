...
row_1_content = [
    ...
    html.H6(
        "Keep borders, then remove them wherever needed with borderstyle",
...
row_2_col_2 = [
    ...
    html.Img(
        src="https://i.redd.it/dwvrl8kddng31.png",
        style={
            "maxWidth": "20%",
            "maxHeight": "20%",
        },
...
row_4_col_1 = [
    ...
    html.H6(
        "Content in a card with cardbody adds extra padding",
        className="card-subtitle",
        style=dict(textAlign="center"),
    ),
]
...
row_4_col_2 = [
    html.H4(
        "Row 4 - Without Cardbody",
        className="card-title",
        style=dict(textAlign="center"),
    ),
    html.H6(
        "The columns in this row are also vertically centered",
        className="card-subtitle",
        style=dict(textAlign="center"),
    ),
]
...
layout = dbc.Container(
    [
        ...
        dbc.Row(
            [
                dbc.Col(
                    dbc.Card(dbc.CardDeck(row_5_deck), style=border_style),
                    xl=12,
                )
            ],
            style=padding_style,
